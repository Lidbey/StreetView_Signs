...
num_classes = 92
classes = np.array(['A-1', 'A-11', 'A-11a', 'A-12a', 'A-14', 'A-15', 'A-16', 'A-17', 'A-18b', 'A-2',
                    ...
                    'D-tablica', 'G-1a', 'G-3', 'Traffic light', 'Traffic light'])

detection_trained_on = np.array(['A-1', 'A-2', 'A-7', 'A-17', 'A-21', 'A-30', 'B-1', 'B-2', 'B-20', 'B-21', 'B-22',
                                 'B-23', 'B-33', 'B-36', 'B-41', 'C-2', 'C-4', 'C-12', 'D-1', 'D-6'])
#                                , 'C-9', 'D-2', 'D-18', 'C-5', 'A-11a', 'D-3'])
